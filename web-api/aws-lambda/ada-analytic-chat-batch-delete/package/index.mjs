...
export const handler = async (event) => {
    ...
    try {
        ...
        console.error('error in ada-analytic-chat-batch-delete ' + random10DigitNumber, e);
    
        const message = {
            Subject: 'ADA Error - ada-analytic-chat-batch-delete ' + random10DigitNumber,
            Message: `Error in ada-analytic-chat-batch-delete ${e.message}\n\nStack trace:\n${e.stack}`,
