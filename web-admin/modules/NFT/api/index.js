...
const whitelistUploadPost = async (params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/nft/whitelist/upload', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('whitelistUploadPost jsonResult', jsonResult)
    return jsonResult
}

const resetQueueStatus = async (params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/nft/queue/status/reset', {
                                method: 'PUT',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('resetQueueStatus jsonResult', jsonResult)
    return jsonResult
}

const deleteAssetPost = async(params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/asset', {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('deleteAssetPost jsonResult', jsonResult)
    return jsonResult
}

const chatDateEncryptionKeyGet = async(params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/admin/encryptionkey/get', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('chatDateEncryptionKeyGet jsonResult', jsonResult)
    return jsonResult
}

const chatDataZKPGenerate = async(params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/chat/zkp/generate', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('chatDataZKPGenerate jsonResult', jsonResult)
    return jsonResult
}

const chatDataZKPVerify = async(params) => {
    let response = await fetch(process.env.ADA_FAN_COMM_API_URL + '/chat/zkp/verify', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + localStorage.getItem("tokyodome_admin_access_token")
    ...
    let jsonResult = response.json()
    console.log('chatDataZKPVerify jsonResult', jsonResult)
    return jsonResult
}

export {nftGet, nftMintPost, storeListing, categoryGet, enumGet, assetGet, announceRevealPost, revealPost, batchRevealPost, 
    whitelistListingPost, whitelistPost, whitelistDel, campaignCodeListingPost, upgradePost, notifyUpgradePost, 
    queueListingPost, queueDelete, queueReset, queuePost, whitelistUploadPost, resetQueueStatus, deleteAssetPost, 
    chatDateEncryptionKeyGet, chatDataZKPGenerate, chatDataZKPVerify}