        ...
        <div className="flex flex-col justify-start items-start h-full w-full text-slate-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                <div className={`h-12 flex items-center w-full ${process.env.IS_TEST == 'true' ? 'bg-[#00224B]' : 'bg-[#212529]'}`}>
                    <h2 className="ml-3 text-sm font-bold">DISCORD USER ANALYSIS</h2>                        
                </div>
                <div className="p-4 w-full">
                    <div className="grid sm:grid-cols-1 grid-cols-3 gap-2">
                        <div className="flex flex-col">
                            ...
                            You are an analyst scoring a user overall messages for enthusiasm (1-5) and knowledge_depth (1-5). Output as JSON object.
                            </textarea>
                            {/* <input type="text" 
...
export default AnalysisDiscordNew