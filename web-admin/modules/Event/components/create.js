...
const EventCreate = () => {
    ...
    const onSubmit = async (data) => {
        ...
        let result = await eventPost({
                                        ...
                                        maxUsersPerRoom: data.maxusersperroom,
        ...
        if(result.Success) {
            ...
            showFailed("Event create failed with message: " + result.Message)
    }
        ...
        <div className="flex flex-col justify-start items-start h-full w-full text-slate-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                <div className={`h-12 flex items-center w-full ${process.env.IS_TEST == 'true' ? 'bg-[#00224B]' : 'bg-[#212529]'}`}>
                    <h2 className="ml-3 text-sm font-bold">CREATE EVENT</h2>                        
                </div>
                <div className="p-4 w-full">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex col-span-2 gap-2">
                                <div className="flex flex-col">
                                    ...
                                    {errors.numberofrooms?.type === 'required' && <p className="text-red-500">Number of Room is required</p>}
                                </div>
                                <div className="flex flex-col">
                                    <label>Max Users Per Room</label>
                                    <input type="text" 
                                        placeholder="Max users per room" 
                                        className="input input-bordered w-full max-w-[300px]"
                                        {...register("maxusersperroom", {required: true})} />
                                    {errors.maxusersperroom?.type === 'required' && <p className="text-red-500">Max users per room is required</p>}
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="relative overflow-hidden btn bg-slate-600">
                                <input type="file"
                                        ...
                                        {...register("poster", {required: true, onChange: (e) => uploadImage(e)})}/>
                                Choose File
                            </div>
                    ...
                    <br/>
                    <button className="mt-5 btn btn-primary btn-sm" type="submit">Create Event</button>
