...
import { avatarCategoryListing, avatarCategoryPost, avatarCategoryPut } from "../api";
...
const AvatarCategoryListing = () => {
    ...
    const getAvatarCategories = async () => {
        ...
        if(result.Success) {
            ...
            if(result.Data.AvatarCategories.length > 0 && result.Data.lastKey) {
    ...
    return (
        <div className="flex flex-col justify-start items-start h-full w-full text-slate-100">
            ...
            <div className={`h-12 flex items-center w-full ${process.env.IS_TEST == 'true' ? 'bg-[#00224B]' : 'bg-[#212529]'}`}>
                <h2 className="ml-3 text-sm font-bold">AVATAR CATEGORY</h2>   
            </div>
            <div className="p-4 w-full">
                <div className={`relative flex flex-col break-words rounded-sm min-w-0 items-center ${process.env.IS_TEST == 'true' ? 'bg-[#00224B]' : 'bg-[#212529]'}`}>
                    <div className="w-full justify-start">
                        <button className="btn btn-primary btn-sm my-2 ml-2" onClick={() => router.push("/metaverse/avatarcategory/create")}>+ CREATE NEW</button>
                    </div>
                    <div className={`card w-full shadow- mb-4 ${process.env.IS_TEST == 'true' ? 'bg-[#00224B]' : 'bg-[#212529]'}`}>
                        <div className="card-body">
                            <div className="grid grid-cols-4 gap-2">
                                ...
                                <div className="flex flex-col">
                                    <label>Avatar Category Id</label>
                                    <input type="text" 
                                        placeholder="Avatar Category Id" 
                                                    ...
                                                    <td>
                                                        <div className="dropdown dropdown-down">
                                                            ...
                                                            <ul tabIndex="0" className="dropdown-content menu p-2 shadow bg-[#212529] rounded-box w-52">
                                                                <li>
                                                                    <a onClick={() => router.push("/metaverse/avatarcategory/edit/" + x.AvatarCategoryId)}>Edit</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
...
export default AvatarCategoryListing